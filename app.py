...
sidebar = html.Div(
    [
        html.Img(src="test.webp",
                 style={"margin-top": "30px", "margin-bottom": "20px", "width": "20px", "height": "20"}),
        html.Hr(),
        dbc.Nav(
            [
    ...
    if pathname == "/":
        ...
        return [
            ...
            html.Div([
                html.Br(),
                dbc.Row([
                    html.H1("AI & Data Science Salary Explorer", style={"font":"bold 40px tahoma",'color': '#1976D2', "text-align": "center"})
